    ...
    >
      <div className="max-w-7xl mx-auto py-5 px-4">
        <h2 className="text-lg md:text-4xl mb-4 text-black dark:text-white max-w-4xl">
          ...
          <strong className="text-primary">{tripDetails.destination}</strong> is
          Ready
        </h2>
        <p className="text-neutral-700 dark:text-neutral-300 text-sm md:text-base max-w-sm">
          Here&apos;s your personalized travel itinerary with all the amazing
          places you&apos;ll visit.
        </p>
        ...
        <div className="flex gap-4 mt-6">
          <div className="flex gap-2 items-center ">
            <Calendar />
            <p className="font-bold">{tripDetails.duration}</p>
          </div>
          ...
          <div className="flex gap-2 items-center ">
            <Users />
            <p className="font-bold">{tripDetails.group_size}</p>
          </div>
        </div>
      </div>
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        {data.map((item, index) => (
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm lg:w-[40%] w-full">
